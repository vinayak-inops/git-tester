...
export default function DivisionManagement() {
  ...
  const paginatedDivisions = filteredDivisions.slice(startIndex, startIndex + itemsPerPage)
          ...
          <CardContent className="p-0">
            ...
            <div className="flex items-center justify-between p-4 border-t">
              <div className="text-sm text-gray-600">
                Showing {startIndex + 1} to {Math.min(startIndex + itemsPerPage, filteredDivisions.length)} of{" "}
