...
import { MapPin, Building2, Users, Briefcase, Award, Layers, FolderOpen, UserCheck, GraduationCap, Settings, Plus, Eye, Edit, Trash2, Building, Globe, Hash } from "lucide-react";
...
export default function SubOrganizationPage() {
    ...
    const {
        ...
        url: 'map/organization/search?_id=6839a36e20fbaf23ae2c410c',
        onSuccess: (data: any) => {
    ...
    return (
        <div className="px-12 py-4">
            ...
            <FormComponent
                ...
                onSuccess={(updatedOrganizationData) => {
