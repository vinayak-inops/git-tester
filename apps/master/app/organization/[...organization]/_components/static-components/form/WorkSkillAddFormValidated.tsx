...
export default function WorkSkillAddFormValidated({ open, setOpen, organizationData = {}, onSuccess, onServerUpdate, editData, isEditMode, deleteValue }: WorkSkillFormModalProps) {
  ...
  const handleDeleteItem = async (workSkillCode: string) => {
    try {
      ...
      if (!response.ok) {
        throw new Error(responseData.message || 'Failed to delete work skill')
      }
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="workSkillCode">Work Skill Code</Label>
                  <Input
                    id="workSkillCode"
                ...
                <div className="space-y-2">
                  <Label htmlFor="workSkillTitle">Work Skill Title</Label>
                  <Input
                    id="workSkillTitle"
