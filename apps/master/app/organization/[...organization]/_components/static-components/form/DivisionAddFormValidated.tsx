            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select onValueChange={handleLocationCodeSelect} disabled={!selectedSubsidiaryCode}>
                    <SelectTrigger>
                      <SelectValue placeholder={selectedSubsidiaryCode ? "Select location codes" : "First select a subsidiary"} />
                    </SelectTrigger>
                    <SelectContent>
