...
export default function NatureOfWorkAddFormValidated({ open, setOpen, organizationData = {}, onSuccess, onServerUpdate, editData, isEditMode, deleteValue }: NatureOfWorkFormModalProps) {
  ...
  const handleDeleteItem = async (natureOfWorkCode: string) => {
    try {
      ...
      if (!response.ok) {
        throw new Error(responseData.message || 'Failed to delete nature of work')
      }
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="natureOfWorkCode">Nature of Work Code</Label>
                  <Input
                    id="natureOfWorkCode"
                ...
                <div className="space-y-2">
                  <Label htmlFor="natureOfWorkTitle">Nature of Work Title</Label>
                  <Input
