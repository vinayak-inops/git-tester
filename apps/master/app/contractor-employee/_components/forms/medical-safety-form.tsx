...
interface MedicalSafetyFormProps {
  formData: MedicalSafetyFormData
  onFormDataChange: (data: Partial<MedicalSafetyFormData>) => void
  onPreviousTab?: () => void
  onNextTab?: () => void
}

export function MedicalSafetyForm({ formData, onFormDataChange, onPreviousTab, onNextTab }: MedicalSafetyFormProps) {
