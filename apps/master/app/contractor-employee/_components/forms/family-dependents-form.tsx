...
const familyDependentsSchema = z.object({
  familyMember: z.array(z.object({
    ...
    aadharCard: z.object({
      aadharCardNumber: z.string().min(1, "Aadhar number is required"),
      aadharCardPath: z.string().optional(),
    }),
    electionCard: z.object({
      electionCardNumber: z.string().min(1, "Election card number is required"),
...
interface FamilyDependentsFormProps {
  formData: FamilyDependentsData
  onFormDataChange: (data: Partial<FamilyDependentsData>) => void
  onNextTab?: () => void
  onPreviousTab?: () => void
}
...
export function FamilyDependentsForm({ formData, onFormDataChange, onNextTab, onPreviousTab }: FamilyDependentsFormProps) {
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <Button type="button" onClick={addFamilyMember} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center gap-2">
                  ...
                  <div key={index} className="p-6 border border-gray-200 rounded-xl bg-gray-50/50">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {watchedValues.familyMember.length > 1 && (
                          <Button type="button" variant="outline" size="sm" onClick={() => removeFamilyMember(index)} className="text-red-600 hover:text-red-700"><Trash2 className="h-4 w-4" /></Button>
                        )}
                      </div>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                      <div className="group">
                        ...
                        <Input {...register(`familyMember.${index}.memberName`)} className={`h-10 border-2 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 rounded-lg ${(showErrors && errors.familyMember?.[index]?.memberName) ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : ""}`} placeholder="Enter member name" />
                      ...
                      <div className="group">
                        ...
                        <Select value={member.relation} onValueChange={value => { setValue(`familyMember.${index}.relation`, value); onFormDataChange({ familyMember: watchedValues.familyMember.map((m, i) => i === index ? { ...m, relation: value } : m) }) }}>
                      ...
                      <div className="group">
                        ...
                        <Select value={member.gender} onValueChange={value => { setValue(`familyMember.${index}.gender`, value); onFormDataChange({ familyMember: watchedValues.familyMember.map((m, i) => i === index ? { ...m, gender: value } : m) }) }}>
                      ...
                      <div className="group">
                        ...
                        <Input type="date" {...register(`familyMember.${index}.birthDate`)} className={`h-10 border-2 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 rounded-lg ${(showErrors && errors.familyMember?.[index]?.birthDate) ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : ""}`} />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-4">
                      ...
                      <div className="group">
                        ...
                        <Input {...register(`familyMember.${index}.aadharCard.aadharCardNumber`)} className={`h-10 border-2 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 rounded-lg ${(showErrors && errors.familyMember?.[index]?.aadharCard?.aadharCardNumber) ? "border-red-500 focus:border-red-500 focus:ring-red-500/20" : ""}`} placeholder="Enter Aadhar number" />
                        ...
                        <div className="relative mt-2">
                          <Input type="file" accept=".pdf,.jpg,.jpeg,.png" onChange={e => { const file = e.target.files?.[0]; if (file) { setValue(`familyMember.${index}.aadharCard.aadharCardPath`, file.name); onFormDataChange({ familyMember: watchedValues.familyMember.map((m, i) => i === index ? { ...m, aadharCard: { ...m.aadharCard, aadharCardPath: file.name } } : m) }) } }} className="hidden" id={`aadharCardPath${index}`} />
                      ...
                      {/* Election Card */}
                      <div className="group">
                        <Label className="text-sm font-medium text-gray-700">Election Card Number <span className="text-red-500">*</span></Label>
                      ...
                      {/* PAN Card */}
                      <div className="group">
                        <Label className="text-sm font-medium text-gray-700">PAN Card Number <span className="text-red-500">*</span></Label>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <Button type="button" onClick={addPfNominee} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center gap-2">
                ...
                {watchedValues.pfNominee.map((nominee, index) => (
                  <div key={index} className="p-6 border border-gray-200 rounded-xl bg-gray-50/50">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {watchedValues.pfNominee.length > 1 && (
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                      ...
                      <div className="group">
                        <Label className="text-sm font-medium text-gray-700">Percentage <span className="text-red-500">*</span></Label>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <Button type="button" onClick={addGratuityNominee} className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center gap-2">
                ...
                {watchedValues.gratuityNominee.map((nominee, index) => (
                  <div key={index} className="p-6 border border-gray-200 rounded-xl bg-gray-50/50">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      {watchedValues.gratuityNominee.length > 1 && (
