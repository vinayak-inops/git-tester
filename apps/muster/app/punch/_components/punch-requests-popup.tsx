...
import PunchStatusUpdate from "./punch-status-update"
...
export default function PunchRequestsPopup({ isOpen, onClose, punchRequests, initialSelectedRequest }: PunchRequestsPopupProps) {
