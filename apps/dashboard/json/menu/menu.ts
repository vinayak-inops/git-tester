export const navItems = [
    {
      ...
      dropdown: "Dashboard",
      items: [
        { icon: "Radio", label: "Live Dashboard",
          link: "/dashboard"
         },
        { icon: "FolderClock", label: "Historic Dashboard",
          link: "/dashboard1"
         }
        // { icon: "GitBranch", label: "Subsidiary",
        //   link: "/organization/subsidiary"
        //  },
        // { icon: "Split", label: "Division",
        //   link: "/organization/division"
        //  },
        // { icon: "BadgeInfo", label: "Designation",
        //   link: "/organization/designation"
        //  },
        // { icon: "Layers", label: "Department",
        //   link: "/organization/department"
        //  },
        // { icon: "ListOrdered", label: "Sub Department",
        //   link: "/organization/sub-department"
        //  },
        // { icon: "Rows", label: "Section",
        //   link: "/organization/section"
        //  },
        // { icon: "Star", label: "Grade",
        //   link: "/organization/grade"
        //  }
      ]
    },
    // {
    ...
    //       link: "/contractor-employee/contractor"
    //      },
    //     { icon: "Users", label: "Company Employee",
    //       link: "/contractor-employee/company-employee"
    //      },
    ...
    //       link: "/contractor-employee/employee-shift"
    //      },
    ...
    //      },
    //     { icon: "Repeat2", label: "Assign Auto Shift",
    ...
    //       link: "/policy/shift"
    //      },
    //     { icon: "ClipboardList", label: "Shift Policy",
    //       link: "/policy/shift-policy"
    //      },
