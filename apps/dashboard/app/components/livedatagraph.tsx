...
import { Line, Pie, PieChart, ResponsiveContainer, XAxis, YAxis, LineChart } from "recharts"
import {
    Chart as ChartJS,
    CategoryScale,
    LinearScale,
...
const staticChartData = [
    { name: "in", value: 275, fill: "var(--color-chrome)" },
    { name: "out", value: 200, fill: "var(--color-safari)" },
