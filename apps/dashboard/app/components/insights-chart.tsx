...
const weekData: DayData[] = [
    { day: 'Sunday', value: 15, color: '#60A5FA' },
    { day: 'Monday', value: 20, color: '#38BDF8' },
    { day: 'Tuesday', value: 25, color: '#06B6D4' },
    { day: 'Wednesday', value: 18, color: '#14B8A6' },
    { day: 'Thursday', value: 22, color: '#10B981' },
    { day: 'Friday', value: 35, color: '#84CC16' },
    { day: 'Saturday', value: 8, color: '#FB923C' },
];
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm justify-center">
            {data.map((item) => (
                <div key={item.day} className="flex items-center gap-1.5">
                    ...
                    />
                    <span className="text-gray-600 whitespace-nowrap">{item.day}</span>
                </div>
            ))}
        </div>
    );
