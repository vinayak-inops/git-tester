...
function ExpenseItem({ icon, title, amount }: { icon: any, title: string, amount: number }) {
  return (
...
function ProductQuestion({ avatar, product, question }: { avatar: string, product: string, question: string }) {
  return (
...
function ProductReview({ avatar, product, review }: { avatar: string, product: string, review: string }) {
  return (
    <div className="flex gap-3">
      <Avatar>
        <img src={avatar || "/placeholder.svg"} alt={product} />
...
function ShippingOrder({ avatar, product }: { avatar: string, product: string }) {
  return (
    <div className="flex gap-3">
      <Avatar>
        <img src={avatar || "/placeholder.svg"} alt={product} />
