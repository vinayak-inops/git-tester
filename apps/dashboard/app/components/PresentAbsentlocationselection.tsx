...
export default function PresentAbsentLocationSelection({ name }: { name: string }) {
    ...
    useEffect(() => {
        fetch("http://192.168.70.176:8080/api/query/attendance/headcount") // calls Next.js API route or proxy
            .then(res => res.json())
    ...
    useEffect(() => {
        fetch("http://192.168.70.176:8080/api/query/attendance/shift")  // replace with your real API
            .then(res => res.json())
            .then(data => {
